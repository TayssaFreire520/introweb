...
//Etapa 1: Etapa 1: Preparando os Dados (JSON)
...
const musicaRemix = {
    ...
    versao: "Remix", //Criando uma nova propriedade
};
...
// 5.1: Uma função que lista todas as músicas
function listarMusicas(lista) {
    console.log("\n ---Etapa 5: Listando Todas as Músicas---");
    lista.forEach((musica) => {
        console.log(`Música: ${musica.titulo} - Artista: ${artista}`);
    });
}
